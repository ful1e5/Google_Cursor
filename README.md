...
- [MeWe](www.mewe.com/i/kaizkhatri)
...
<p align="center">
<a  href="https://www.paypal.me/kaizkhatri"><img title="Kaiz's Paypal" width=47% src="https://www.paypalobjects.com/webstatic/mobile/hob/web/pp_here_flat.png"></a>
</br>
...
3. **Uninstall**:
   ...
   ```bash
   #From ROOT
   $sudo rm -r /usr/share/icons/Google_*
   #from Local User
   $rm -r ~/.icons/Google_*
